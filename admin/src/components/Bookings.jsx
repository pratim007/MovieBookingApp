...
import {styles2, fontStyles2} from '../assets/dummyStyles'
import axios from 'axios';
import {X, Film, Clock, Ticket} from 'lucide-react';
...
const Bookings = () => {
  ...
  return (
    <div className={styles2.pageContainer} style={fontStyles2.cinzelFont}>
