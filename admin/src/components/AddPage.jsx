...
function toggleCategory(cat) {
 ...
 // file helpers
  ...
  // slots helpers add remove and update slot timings for a movie
function addSlot() {
  setSlots((s) => [
    ...s,
...
//this fdunction validates all the fields are validate or not and filled or not
  function validate() {
