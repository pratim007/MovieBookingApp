...
import {Film, Ticket, Star, Calendar, Play as PlayIcon, Search,X,Play,Clock} from 'lucide-react';
...
function getImageUrl(maybe) {
  ...
  if (!maybe.startsWith("http://") && !maybe.startsWith("https://")) {
    ...
    url = `${API_BASE}/uploads/${cleaned}`;
  }
  // Collapse double slashes (except in protocol)
